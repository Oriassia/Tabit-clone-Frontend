...
export function ReservationSelector({
  ...
  return (
    <div className="flex border-2 rounded-full font-bold font-rubik text-white border-greenButton w-[400px] lg:min-w-[450px] bg-greenBg">
      <div className="flex flex-col items-center px-[37px] lg:px-[45px] py-[0.5em] lg:text-[19px] border-r-2 border-greenButton">
        ...
        <DropdownMenu>
          ...
          >
            ...
            {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((guestNum) => (
              <DropdownMenuItem
                key={guestNum}
                className={`hover:bg-greyHoverDropDownMenu rounded-none cursor-pointer px-4 py-3 ${
